...
#### 6. 🎵 音效系統測試
- **音效優先級**：T-Spin > 高連擊(4+) > 一般連擊 > 四行消除 > 標準消行
...
3. **等級1，四行消除+Combo**：800 + 50×1×1 = 850分
4. **連續兩次四行消除**：第二次應有B2B獎勵 (800×1.5 = 1200分)
...
🎯 **測試目標**：確認得分系統和連擊系統運作正確，UI 顯示準確，視覺特效流暢。
